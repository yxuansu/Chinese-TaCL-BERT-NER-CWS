...
def parse_config():
    ...
    parser.add_argument("--model_name", type=str, default="cambridgeltl/tacl-bert-base-chinese")
...
if __name__ == '__main__':
    ...
    if cuda_available:
        ...
        model_ckpt = torch.load(args.saved_ckpt_path, map_location=torch.device('cpu'))
